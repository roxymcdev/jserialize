...
public final class InstantKeyAdapter extends AbstractTemporalKeyAdapter<Instant> {
    ...
    private InstantKeyAdapter(DateTimeFormatter formatter) {
    ...
    public static Factory factory(DateTimeFormatter formatter) {
        return Factory.exact(new InstantKeyAdapter(formatter));
    }
